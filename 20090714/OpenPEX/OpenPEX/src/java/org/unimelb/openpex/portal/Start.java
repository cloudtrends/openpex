 ...
 * Start.java
 *
 * Created on Mar 18, 2009, 12:28:01 PM
 * Copyright brobergj
 */
...
public class Start extends AbstractPageBean {
    ...
    public String newResButton_action() {
        //return null means stay on the same page
        return "case2";
    }

    public String viewResButton_action() {
        //return null means stay on the same page
        return "case1";
    }

    public String viewAccountButton_action() {
        //return null means stay on the same page
        return null;
    }

    public String viewVMButton_action() {
        //return null means stay on the same page
        return "case3";
    }
