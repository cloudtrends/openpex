...
public class PexOperationFailedException extends PexException {

	public PexOperationFailedException(String msg) {
		super(msg);
	}
	
	public PexOperationFailedException(String msg, Throwable cause){
		super(msg,cause);
	}
}
