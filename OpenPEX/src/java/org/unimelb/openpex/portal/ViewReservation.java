 ...
 */
public class ViewReservation extends AbstractPageBean {
    ...
    public void init() {
        ...
        try {
            ...
            log("ViewReservation Initialization Failure", e);
    ...
    public void prerender() {
        getDataTable1Model().setWrappedData(this.getSessionBean1().getReservations());
    }
    ...
    public void activateButton_processAction(ActionEvent ae) {
        // TODO: Replace with your code
        ResourceManager resM = null;
        String requestId = null;
        String vmID;

        ReservationEntity selectedRes = (ReservationEntity) this.getDataTable1Model().getRowData();
        ...
        //VMListener listener;
        if (selectedRes != null) {
            requestId = selectedRes.getRequestId();
            System.out.println("You selected requestid " + requestId + " for activation");
        } else {
            System.out.println("Getting row failed");
        }
        ...
        try {
            vmID = resM.createVM(requestId, sessBean.getUser().getUsername() + "-" +
                    Math.abs(r.nextInt()));
            resM.startVM(requestId, vmID, null);
    ...
    public void deleteButton_processAction(ActionEvent ae) {
        ...
        System.out.println("Deleting " + selectedRes.getRequestId());
        ...
        try {
            resM.deleteReservation(selectedRes.getRequestId());
        } catch (PexOperationFailedException ex) {
            Logger.getLogger(ViewReservation.class.getName()).log(Level.SEVERE, null, ex);
        } catch (PexException ex) {
            Logger.getLogger(ViewReservation.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public String activateButton_action() {
