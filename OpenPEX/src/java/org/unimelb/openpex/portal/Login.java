...
public class Login extends AbstractPageBean {
    ...
    private String passwordInputSecret;

    public String getPasswordInputSecret() {
        return passwordInputSecret;
    }

    public void setPasswordInputSecret(String his) {
        this.passwordInputSecret = his;
    }
    ...
    public String signInButton_action() {
        //return null means stay on the same page
        PexStorage store = this.getSessionBean1().getStore();
        VmUser user = store.getUserByCred(this.getUsernameInputText(),
                this.getPasswordInputSecret());
        if (user != null) {
            this.getSessionBean1().setUser(user);
            return "case2";
        } else {
            return "null";
        }
