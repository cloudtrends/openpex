 ...
 * @author srikumar
 */
public class PexStorageFailedException extends PexException{

    public PexStorageFailedException(String msg) {
        super(msg);
    }

    public PexStorageFailedException(String msg, Throwable cause) {
        super(msg, cause);
    }
